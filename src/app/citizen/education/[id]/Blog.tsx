...
import { blogs } from "@/app/citizen/data/blogs";
  ...
  if (!blog) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/citizen/education" className="text-emerald-600 hover:text-emerald-800 font-medium">
              ...
              relatedBlogs.map((relatedBlog) => (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <Link
                      href={`/citizen/education/${relatedBlog.id}`}
